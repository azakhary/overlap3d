...
public class UIBasicItemProperties extends UIItemProperties {
    ...
    public UIBasicItemProperties() {
        ...
        zValue = StandardWidgetsFactory.createValidableTextField(floatValidator);
        ...
        add(getAsTable("X:", xValue, "Y:", yValue, "Z:", zValue)).left();
    ...
    private Table getAsTable(String text1, Actor actor1, String text2, Actor actor2,String text3, Actor actor3) {
        ...
        positionTable.row().padTop(4);
        positionTable.add(createLabel(text3)).right().padRight(3);
        positionTable.add(actor3).width(45).height(21).left();
    ...
    public String getZValue() {
        return zValue.getText();
    }

    public void setZValue(String xValue) {
        this.zValue.setText(xValue);
    }
    ...
    private void setListeners() {
        ...
        zValue.addListener(new KeyboardListener(getUpdateEventName()));
