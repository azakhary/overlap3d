...
public class CompositeCameraChangeCommand extends RevertableCommand {
    ...
    public void doAction() {
        ...
        CameraComponent cameraComponent = ComponentRetriever.get(oldEntity, CameraComponent.class);
        oldEntity.remove(CameraComponent.class);
    ...
    public void undoAction() {
        ...
        CameraComponent cameraComponent = ComponentRetriever.get(currEntity, CameraComponent.class);
        currEntity.remove(CameraComponent.class);
        oldEntity.add(cameraComponent);
